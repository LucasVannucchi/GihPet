package br.com.banhoetosa.gihpet.servicos.api.controller;
...
import br.com.banhoetosa.gihpet.servicos.domain.service.ServicoService;
...
public class ServicoController {
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Cancelar serviço")
